...
export default function PermissionsScreen() {
  ...
  const [mediaStatus, setMediaStatus] =
    useState<SystemGalleryPermission | null>(null);
  ...
  const permitirTudo = async () => {
    ...
    const med = mediaOk(mediaStatus)
      ? mediaStatus
      : await requestSystemGalleryPermission();
    setMediaStatus(med);
    ...
    <SafeAreaView style={styles.root}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          Para traduzir a vibe do momento em filtro e trilha sonora, o
          Synesthesia precisa de dois acessos — e usa um terceiro, se você
          deixar:
        </Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardText}>
            ...
            <Text style={styles.cardDesc}>
              Para salvar suas capturas com filtro e música, prontas para
              compartilhar.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardText}>
            ...
            <Text style={styles.cardDesc}>
              Para a vibe combinar com o lugar — praia, cidade, estrada. Só a
              cidade é enviada, nunca sua posição exata, e nada fica guardado.
              Pode recusar: o app funciona igual.
            </Text>
          </View>
        </View>

        <Text style={styles.privacy}>
          🔒 Tudo processado no seu celular. Suas imagens não saem do
          dispositivo sem você mandar.
        </Text>
      </View>
        ...
        {negado ? (
          <>
            <Text style={styles.deniedText}>
              Sem esses acessos a câmera não abre. Você pode liberar nas
