# ADR-0001 — Modelo de IA para a curadoria musical

**Status**: Aceita · **Data**: 2026-07-09 · **Última revisão**: 2026-08-04

Registro da decisão de qual LLM usar na curadoria musical do Synesthesia (feature-chave do produto).
...
Guia para obter a chave: [runbooks/configurar-gemini.md](../runbooks/configurar-gemini.md).
